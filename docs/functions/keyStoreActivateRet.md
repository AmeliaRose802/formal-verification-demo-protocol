...
> 🧩 **Model abstraction.** Cryptol model of KeyStore::activate's result ladder; implementation-level SAW proof pending. No production function is proven equivalent to this definition on this page.
