...
| `id_bad` | impl (cpp) | `id_spec` | — | `C:/Users/ameliapayne/demo_protocol/cpp/saw/_tiny_verified_disproved/scalar.cpp` |
| `id_good` | impl (cpp) | `id_spec` | — | `C:/Users/ameliapayne/demo_protocol/cpp/saw/_tiny_verified_disproved/scalar.cpp` |
| `isActive` | impl (cpp) | `keyStoreIsActiveRet` | — | `C:/Users/ameliapayne/demo_protocol/cpp/src/key_store.cpp` |
| `isValidClaims` | impl (cpp) | — | — | `C:/Users/ameliapayne/demo_protocol/cpp/src/auth.cpp` |
| `isValidSignature` | impl (cpp) | — | — | `../src/auth.cpp` |
| `outerFirstByte` | impl (cpp) | `outerFirstByte_disproved` | — | `C:/Users/ameliapayne/demo_protocol/cpp/saw/_nested_raw_bytes_repro/nested_raw_bytes.cpp` |
| `outerHasData` | impl (cpp) | `outerHasDataSpec123` | — | `C:/Users/ameliapayne/demo_protocol/cpp/saw/_nested_raw_bytes_repro/nested_raw_bytes.cpp` |
| `provision` | impl (cpp) | `keyStoreProvisionRet` | — | `C:/Users/ameliapayne/demo_protocol/cpp/src/key_store.cpp` |
| `readNested_bad` | impl (cpp) | `readNested_spec` | — | `C:/Users/ameliapayne/demo_protocol/cpp/saw/_tiny_verified_disproved/tiny.cpp` |
| `readNested_good` | impl (cpp) | `readNested_spec` | — | `C:/Users/ameliapayne/demo_protocol/cpp/saw/_tiny_verified_disproved/tiny.cpp` |
...
| Function | Source | Maps to | Reason codes | Notes |
|----------|--------|---------|--------------|-------|
| [`authenticate`](functions/authenticate.md) | model + impl (SDEP_cpp ↔ cpp) | — | — | `C:/Users/ameliapayne/demo_protocol/cpp/include/sdep/auth.hpp` · `z3` |
| [`enforceAccess`](functions/enforceAccess.md) | model + impl (SDEP_cpp ↔ cpp) | — | — | `C:/Users/ameliapayne/demo_protocol/cpp/include/sdep/access.hpp` · `z3` |
| [`enrollDevice`](functions/enrollDevice.md) | model + impl (SDEP_cpp ↔ cpp) | — | — | `C:/Users/ameliapayne/demo_protocol/cpp/include/sdep/decision.hpp` · `z3` |
| [`getStatus`](functions/getStatus.md) | model + impl (SDEP_cpp ↔ cpp) | — | — | `C:/Users/ameliapayne/demo_protocol/cpp/include/sdep/decision.hpp` · `z3` |
| [`isValidRequestDate`](functions/isValidRequestDate.md) | model + impl (SDEP_cpp ↔ cpp) | — | — | `C:/Users/ameliapayne/demo_protocol/cpp/include/sdep/auth.hpp` · `z3` |
