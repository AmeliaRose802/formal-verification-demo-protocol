...
|----------|-------------|
| [inWindow](inWindow.md) | Matches C++ `bool inWindow(std::int64_t reqTs, std::int64_t now, std::int64_t window)`. |
| [isNonNull](isNonNull.md) | Matches C++ `bool isNonNull(void* p)`. |
| [pickGreater](pickGreater.md) | Matches C++ `std::int64_t pickGreater(std::int64_t a, std::int64_t b)`. |
